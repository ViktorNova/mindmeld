...
if (Teams.find().count() === 0) {
  ...
  IssueRankings.insert({
    teamId: weaponXId,
    projectId: xtinctionAgendaId,
    issueIds: [issueOneId, issueTwoId, issueThreeId, issueFourId, issueFiveId, issueSixId, issueSevenId, issueEightId, issueNineId, issueTenId, issueElevenId, issueTwelveId]
  });
} 
